// lib/screens/import_screen_new.dart
import 'dart:io';
...
class ImportScreenNew extends StatefulWidget {
  ...
  const ImportScreenNew({Key? key}) : super(key: key);

  @override
  State<ImportScreenNew> createState() => _ImportScreenNewState();
}

class _ImportScreenNewState extends State<ImportScreenNew> {
